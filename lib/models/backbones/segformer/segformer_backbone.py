...
class OverlapPatchEmbed(nn.Module):
    def __init__(self, patch_size=7, stride=4, in_chans=1, embed_dim=768):
        super().__init__()
    ...
    def forward(self, x):
        x = self.proj(x)    # 16,1,256,256 -->  16,64,64,64
        _, _, H, W = x.shape
        x = x.flatten(2).transpose(1, 2)   # 16,64,64,64 -->  16,64,4096 -->  16,4096,64
        x = self.norm(x)
...
class SegformerBackbone(object):
