    ...
    def init_optimizer(self, net_params): 
        ...
        if policy == 'step':
            scheduler = lr_scheduler.StepLR(optimizer,
                                            ...
                                            gamma=self.configer.get('lr', 'step')['gamma'])     # this
        ...
        if self.configer.get('network', 'resume') is not None:    
            ...
            optimizer =  optimizer.load_state_dict(resume_dict['optimizer'])  
            scheduler = scheduler.load_state_dict(resume_dict['scheduler'])
